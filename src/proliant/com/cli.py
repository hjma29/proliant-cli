...
# lives in common.prompts; re-exported here under the original private names
# so existing call sites (and tests that patch these exact names) keep working.
from proliant.common.prompts import (
    _read_password_masked_windows,
    _read_password_masked_posix,
    prompt_password as _prompt_password,
    prompt_password_async as _prompt_password_async,
)
