...
from proliant.common.display import get_console, print_json, print_memory_report, OutputMode, get_output_mode
...
async def run_report_gpu(session: COMSession) -> None:
    from proliant.com.inventory import get_fleet_gpus, aggregate_gpus_by_model
...
async def run_report_memory(session: COMSession) -> None:
    from proliant.com.inventory import get_fleet_memory, aggregate_by_part_number
