"""
CLI-level JSON output tests for proliant qs --json.
"""
...
class TestQsParserJson:
    def test_parser_accepts_json_flag(self):
        from proliant.qs.cli import _build_parser
...
class TestQsDescribeJson:
    def test_describe_json_is_valid(self, capsys):
        ...
        with patch("proliant.qs.cli.fetch_quickspec_markdown", return_value=(FAKE_MARKDOWN, FAKE_SECTIONS)):
